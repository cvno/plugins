...
class User2Role(models.Model):
    ...
    用户角色关系表
    """
    user = models.ForeignKey(User, verbose_name='用户', related_name='roles', on_delete=models.DO_NOTHING)
    role = models.ForeignKey(Role, verbose_name='角色', related_name='users', on_delete=models.DO_NOTHING)
...
class Menu(models.Model):
    ...
    parent = models.ForeignKey('self', verbose_name='父菜单', related_name='p', null=True, blank=True, on_delete=models.DO_NOTHING)
...
class Permission2Action2Role(models.Model):
    ...
    权限操作关系表
    """
    permission = models.ForeignKey(Permission, verbose_name='权限URL',on_delete=models.DO_NOTHING, related_name='actions')
    action = models.ForeignKey(Action, verbose_name='操作',on_delete=models.DO_NOTHING, related_name='permissions')
    role = models.ForeignKey(Role, verbose_name='角色',on_delete=models.DO_NOTHING, related_name='p2as')
